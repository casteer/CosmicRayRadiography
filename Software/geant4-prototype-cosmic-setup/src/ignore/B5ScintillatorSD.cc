...
B5ScintillatorSD::B5ScintillatorSD(G4String name)
...
B5ScintillatorSD::~B5ScintillatorSD()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void B5ScintillatorSD::Initialize(G4HCofThisEvent* hce)
{
    fHitsCollection = new B5ScintillatorHitsCollection(GetName(),collectionName[0]);
...
// 3. Time of hit
G4bool B5ScintillatorSD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
