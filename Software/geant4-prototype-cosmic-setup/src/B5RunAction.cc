 ...
 : G4UserRunAction()
{
  ...
  analysisManager->CreateNtupleDColumn("EDep0");         // column Id = 0
  analysisManager->CreateNtupleDColumn("Time0");     // column Id = 1
  analysisManager->CreateNtupleDColumn("EDep1");         // column Id = 0
  analysisManager->CreateNtupleDColumn("Time1");     // column Id = 1
  analysisManager->CreateNtupleDColumn("DelTime");     // column Id = 1
  analysisManager->CreateNtupleDColumn("ThetaXZ");         // column Id = 0
  analysisManager->CreateNtupleDColumn("ThetaYZ");     // column Id = 1
