...
public:
    ...
    ScintillatorHit(G4int, G4double , G4double );
    ScintillatorHit(const B5ScintillatorHit &right);
    virtual ~ScintillatorHit();

    const ScintillatorHit& operator=(const B5ScintillatorHit &right);
...
extern G4ThreadLocal G4Allocator<BcintillatorHit>* ScintillatorHitAllocator;
