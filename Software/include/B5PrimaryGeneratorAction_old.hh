...
public:
  ...
  G4double PDGCosmics(G4double theta, G4double E);
...
private:
  ...
  G4double energy_decades;
  G4double energy_divisions;

  G4int E_bins;
  G4int costheta_bins;
  std::vector<G4double> E_scale;
  std::vector<G4double> costheta_scale;
  std::vector<G4double> costhetap_scale;

  std::vector<G4double> cosmics_integral;
